...
#include "../engine/rs_entitycontainer.h"
...
//    std::vector<int> verListLwLineNum;
    ...
    std::vector<RS2::LineType> lineTypeList;
    ...
    virtual bool canImport(const char *&/*fileName*/, RS2::FormatType t) const {
#ifdef DWGSUPPORT
    ...
    virtual bool canExport(const char *&/*fileName*/, RS2::FormatType t) const {
        return (t == RS2::FormatDXFRW || t == RS2::FormatDXFRW2004 || t == RS2::FormatDXFRW2000
                || t == RS2::FormatDXFRW14 || t == RS2::FormatDXFRW12);
    }

    // Import:
    virtual bool fileImport(RS_Graphic &g, const QString &file);
