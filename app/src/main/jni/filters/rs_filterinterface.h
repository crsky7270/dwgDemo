...
public:
     ...
     */
    virtual bool canImport(const char* &fileName, RS2::FormatType t) const = 0;
     ...
     *         false otherwise.
     */
    virtual bool canExport(const char* &fileName, RS2::FormatType t) const = 0;
     ...
     */
    virtual bool fileImport(RS_Graphic& g, const QString& file) = 0;
